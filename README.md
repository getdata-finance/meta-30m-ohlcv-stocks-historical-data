...
> **Sample on GitHub** · `META_30m.csv` (1,848 rows, `2026-02-06` -> `2026-09-01`, 186.21 KB). **Full archive on [getdata.finance](https://getdata.finance/datasets/meta)** — **21,249** `30m` rows (full `1m`: 637,227), **11 timeframes**, `2020-02-25` -> `2026-09-01`.
...
The complete **META** archive on **[getdata.finance](https://getdata.finance/datasets/meta)** includes **11 OHLCV timeframes** (1m · 3m · 5m · 15m · 30m · 1H · 4H · 12H · 1D · 3D · 1W) — **21,249** rows at `30m`, plus all other timeframes in the same ZIP.
